...
export default function GestionUsuarios() {
  ...
  return (
    <LayoutWithSidebar>
      <div className="p-8">
        <div className="mb-8">
          <h1 className="text-3xl text-gray-800 mb-2">Gestión de Usuarios</h1>
          <p className="text-gray-600">Administra el equipo y sus permisos</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl text-gray-800">{users.length}</span>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600">Usuarios Estándar</p>
          </div>
        </div>
      </div>
    </LayoutWithSidebar>
